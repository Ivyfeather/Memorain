...
def add_options(parser):
    parser.add_argument('--dramsim', action='store_true',help='Use DRAMsim3')
    parser.add_argument('--caches', action='store_true',help='Use L1 and L2 cache')
...
# options for se.py, following the order in Options.py
    ...
    if args.dramsim:
        options.append('--mem-type=DRAMsim3 --dramsim3-ini=/home/chenxi/gem5_dramsim/ext/dramsim3/DRAMsim3/configs/DDR4_8Gb_x4_2133.ini')
